                                ...
                                <div class="col-lg-12">
                                    ...
                                    ?>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Action Taken</label>
                                                  <select name="status" id="status" required title="Select status!" class="form-control">
                                                      <option value="Action Taken">YES</option>
                                                      <option value="Job Assigned" >NO</option>
                                                  </select>
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Time Taken (In Days)</label>
                                                  <input type="text" value="<?php echo $time_money; ?>" class="form-control" name="time" id="time" required placeholder="Please enter days taken to solve this problem!"/>
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Action Plan Description</label>
                                                  <textarea name="remarks" id="remarks" class="form-control" required title="Please write description!"><?php echo $remarks; ?></textarea><br>Max: 250 Words
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
