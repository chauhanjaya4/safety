...
-->
        ...
        <script>
          /*   var submit_form = false;
            var errors = "Please correct errors first \n";
            $("[name='username']").on("blur", function () {
                ...
                $.post("ajax.php", {
                    ...
                    if (status === 'success') {
                        if (data === "y") {
                            alert("Email Id " + param_val + " already used");
                            errors += "Email Id " + param_val + " already used";
                            submit_form = false;
                        } else {
                            submit_form = true;
                        }
            ...
            $("[name='personal_number']").on("blur", function () {
                var iobj = $(this);
                var param_val = $(this).val();
                var param_name = "p_no";
                $.post("ajax.php", {
                    ...
                    if (status === 'success') {
                        if (data === "y") {
                            alert("Personal no. " + param_val + " already used");
                            errors += "Personal no. " + param_val + " already used";
                            submit_form = false;
                        } else {
                            submit_form = true;
                        }
...
*/                    
                    "ajax": {
                        ...
                        url: "ajax_report_total.php",
                        data:{report:"month_no"},// json datasource
